...
public class Thermometer extends View {
    ...
    public void init(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.Therm);
        outerCircleRadius = typedArray.getDimension(R.styleable.Therm_radius, 20f);
        int outerColor = typedArray.getColor(R.styleable.Therm_outerColor, Color.GRAY);
        int middleColor = typedArray.getColor(R.styleable.Therm_middleColor, Color.WHITE);
        int innerColor = typedArray.getColor(R.styleable.Therm_innerColor, Color.RED);
